...
const TreeNode = ({ nodeDatum }) => {
  ...
  const getCost = (key) => {
    return (
      <text className="surname" {...getNodeStyleConfis(key)}>
        {getFullName().surname}
      </text>
    );
  };
  ...
  const getFirstname = (key) => {
    return (
      <text className="firstname" {...getNodeStyleConfis(key)}>
  ...
  const getMiddlename = (key) => {
    // const forntSize =
    //   getFullName().middlename.length * 5 > 25
    //     ? getFullName().middlename.length -
    //       (getFullName().middlename.length / 2) * 3
    //     : getFullName().middlename.length * 5;
    return (
      <text className="middlename" {...getNodeStyleConfis(key)}>
  ...
  const getLastname = (key) => {
    return (
      <text className="lastname" {...getNodeStyleConfis(key)}>
  ...
  const getLaqab = (key) => {
    return (
      <text className="laqab" {...getNodeStyleConfis(key)}>
        {getFullName().laqab}
      </text>
    );
  };
